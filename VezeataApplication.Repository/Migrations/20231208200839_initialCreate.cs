        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    NumberOfComletedRequesrt = table.Column<int>(type: "int", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DateOfBirh = table.Column<DateOnly>(type: "date", nullable: true),
            ...
            migrationBuilder.CreateTable(
                name: "DiscountCodeCouponVezeataUser",
                columns: table => new
                {
                    DiscountCodesId = table.Column<int>(type: "int", nullable: false),
                    VezeataUsersId = table.Column<string>(type: "nvarchar(450)", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_DiscountCodeCouponVezeataUser", x => new { x.DiscountCodesId, x.VezeataUsersId });
                    table.ForeignKey(
                        name: "FK_DiscountCodeCouponVezeataUser_AspNetUsers_VezeataUsersId",
                        column: x => x.VezeataUsersId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateIndex(
                name: "IX_DiscountCodeCouponVezeataUser_VezeataUsersId",
                table: "DiscountCodeCouponVezeataUser",
                column: "VezeataUsersId");
